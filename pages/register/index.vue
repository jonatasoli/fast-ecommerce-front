...
const validationSchema = toTypedSchema(z.object({
  ...
  username: z.string().nonempty(t('register.formValidation.requiredUsername')),
  mail: z.string().email(t('register.formValidation.invalidEmail')).nonempty(t('register.formValidation.requiredEmail')),
  document: z.string().nonempty(t('register.formValidation.requiredDocument')),
  password: z.string().min(6, t('register.formValidation.passwordMinLength')).nonempty(t('register.formValidation.requiredPassword')),
  confirmPassword: z.string().nonempty(t('register.formValidation.requiredConfirmPassword')),
  phone: z.string(),
}).refine((value) => {
    ...
    <div class="register__form-container">
      ...
      >
        ...
        <n-form-item
          label="Telefone"
          path="phone"
          :feedback="phoneIsValid ? undefined : `${t('register.formValidation.invalidPhone')}`"
