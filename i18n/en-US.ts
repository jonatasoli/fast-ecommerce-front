export default {
  ...
  login: {
    ...
    username: 'CPF',
    passLabel: 'Password',
    forgotPassLabel: 'Forgot my Passcode',
    submit: 'Login',
    ...
    formValidation: {
      ...
      requiredPassLabel: 'Password is required',
    },
  ...
  resetPassword: {
    ...
    formValidation: {
      ...
      requiredNewPassLabel: 'New password is required',
      requiredConfirmPassLabel: 'Password confirmation is required',
